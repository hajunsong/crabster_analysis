...
def compare_csv(rec_csv="rec_data.csv", sim_csv="rec_data_fix_free_fall.csv"):
    ...
    for j in range(0, 1):
        ...
        for i in range(0, 4):
            ...
            axes[0][i].plot(t_rec, y_rec, label=f"Ref")
        ...
        for i in range(0, 4):
            ...
            axes[1][i].plot(t_rec, y_rec, label=f"Ref")
        ...
        for i in range(0, 4):
            ...
            axes[2][i].plot(t_rec, y_rec, label=f"Ref")
        ...
        for i in range(0, 3):
            ...
            axes2[0][i].plot(t_rec, y_rec, label=f"Ref")
        ...
        for i in range(0, 3):
            ...
            axes2[1][i].plot(t_rec, y_rec, label=f"Ref")
...
if __name__ == "__main__":
    ...
    compare_csv(str(current_file_path) + "/../data/rec_data_fix_free_fall.csv", 
