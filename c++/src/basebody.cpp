...
BaseBody::BaseBody(){
    ...
    FL_s01p = Eigen::Vector3d(520, 758, 0)*1e-3;
    FL_C01 = euler_zxz(M_PI_2, M_PI_2, 0.0);
    ML_s01p = Eigen::Vector3d(0, 858, 0)*1e-3;
    ML_C01 = euler_zxz(M_PI_2, M_PI_2, 0.0);
    RL_s01p = Eigen::Vector3d(-520, 758, 0)*1e-3;
    RL_C01 = euler_zxz(M_PI_2, M_PI_2, 0.0);
    FR_s01p = Eigen::Vector3d(520, -758, 0)*1e-3;
    FR_C01 = euler_zxz(M_PI_2, M_PI_2, 0.0);
    MR_s01p = Eigen::Vector3d(0, -858, 0)*1e-3;
    MR_C01 = euler_zxz(M_PI_2, M_PI_2, 0.0);
    RR_s01p = Eigen::Vector3d(-520, -758, 0)*1e-3;
